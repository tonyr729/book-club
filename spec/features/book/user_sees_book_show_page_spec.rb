...
describe 'As a Visitor' do
  describe 'when I visit a book show page' do
    ...
    it 'shows statistics about the book' do
      ...
      review_2 = user_2.reviews.create(title: "Thrilling book", description: "Park iphone leggings put a bird on it.", rating: 3, book: book_1)
      ...
      review_4 = user_4.reviews.create(title: "I should probably read it again", description: "Didn't really follow what was going on.", rating: 2, book: book_1)
